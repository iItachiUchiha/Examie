...
import LogoutButton from "../../singleComponents/LogoutButton/LogoutButton";
...
import AlertBox from '../../singleComponents/Alertbox/AlertBox';
...
class TeacherHomepage extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      content:(<div>Welcome to Examie The Examination App</div>), // home - welcome message addquestion - add question form
      menuList : [{
        title:'Home',
        content:(<div>Welcome to Examie The Examination App</div>)
      },{
        title: 'Add Question',
